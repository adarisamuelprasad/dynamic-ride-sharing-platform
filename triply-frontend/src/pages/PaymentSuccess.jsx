...
const PaymentSuccess = () => {
    ...
    const [activeTab, setActiveTab] = useState('ticket'); // 'ticket' or 'invoice'
            ...
            <div className="container mx-auto px-4 pt-24 max-w-4xl">
                ...
                {activeTab === 'ticket' && (
                    <div>
                        ...
                        <div ref={ticketRef} className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                            {/* Ticket Header */}
                            <div className="bg-indigo-600 p-6 text-white">
                                <h3 className="text-2xl font-bold tracking-wider text-center">TRIPLY TICKET</h3>
                                <p className="text-indigo-100 text-sm opacity-90 text-center mt-1">Ride Sharing Platform</p>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-gray-900">
                                            {(() => {
                                                ...
                                                try {
                                                    if (Array.isArray(ride.departureTime)) {
                                                        const [, , , h, min] = ride.departureTime;
                                ...
                                <div className="mt-6 pt-4 border-t border-gray-200">
                                    <div className="flex items-center justify-center">
                                        <div className="h-12 w-48 bg-gray-200 rounded"
                                            style={{ backgroundImage: 'repeating-linear-gradient(90deg, transparent, transparent 2px, #000 2px, #000 4px)' }}>
                                        </div>
                                    </div>
                                    <p className="text-xs text-gray-400 text-center mt-2">Valid for one ride</p>
                                </div>
                            </div>
                        </div>
                    </div>
