                    ...
                    <CardContent className="space-y-4">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="flex items-center gap-1 bg-yellow-400/10 text-yellow-600 px-3 py-1 rounded-full border border-yellow-400/20">
                                ...
                                <span className="font-semibold">{user.averageRating ? user.averageRating.toFixed(1) : "New"} ({user.reviewCount || 0} reviews)</span>
                            </div>
                        </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="grid grid-cols-3 gap-2">
                                                ...
                                                {(!vehicleForm.extraImages || vehicleForm.extraImages.length < 10) && (
                                                    <label className="flex aspect-square cursor-pointer items-center justify-center rounded-md border border-dashed hover:bg-red-50">
                            ...
                            {vehicles.map((v) => (
                                <Card key={v.id} className="overflow-hidden">
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                                        {/* Image Preview */}
                                        {v.imageUrl && (
                                            <div className="w-full sm:w-32 h-32 sm:h-auto aspect-video sm:aspect-square bg-cover bg-center" style={{ backgroundImage: `url(${v.imageUrl})` }} />
                                        )}
