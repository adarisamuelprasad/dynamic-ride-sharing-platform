                    ...
                    <div ref={receiptRef} className="bg-white rounded-lg shadow-xl overflow-hidden print:shadow-none">
                                ...
                                <table className="w-full text-left text-sm">
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                        <tr>
                                            ...
                                            <td className="py-4 text-slate-900 text-right font-medium">₹{amount ? Number(amount).toFixed(2) : '0.00'}</td>
                                        </tr>
                                        <tr>
                                            <td className="py-4 text-slate-900">
                                            ...
                                            <td className="py-4 text-slate-900 text-right">1</td>
                                            <td className="py-4 text-slate-900 text-right">₹0.00</td>
                                            <td className="py-4 text-slate-900 text-right font-medium">₹0.00</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div className="bg-slate-50 p-6 border-t border-gray-100 flex justify-between items-center relative overflow-hidden">
                            ...
                            <div className="text-xs text-slate-500 font-mono">
                                Auth: {transactionId || 'TXN_SUCCESS'}
                            </div>
                        </div>
                    </div>
                </div>
