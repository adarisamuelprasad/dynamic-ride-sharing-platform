...
const MyBookings = () => {
    ...
    const handlePay = (booking: Booking) => {
        navigate('/payments', {
            state: {
                ride: booking.ride,
                booking: { seats: booking.seatsBooked },
                        ...
                        {bookings.map((booking, index) => (
                            ...
                            >
                                <BookingCard
                                    booking={{
                                        ...booking,
                                        status: booking.status as "CONFIRMED" | "PENDING" | "CANCELLED" | "COMPLETED" | "APPROVED" | "REJECTED"
                                    }}
                                    onCancel={handleCancelBooking}
                                    onPay={handlePay}
                                    onViewDetails={setSelectedBookingDetails}
                                    onRate={(b) => {
                                        if (b.ride && b.ride.driver) {
                                            setReviewRideId(b.ride.id);
                                            setRevieweeId(b.ride.driver.id);
